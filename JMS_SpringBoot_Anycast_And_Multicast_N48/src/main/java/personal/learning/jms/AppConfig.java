...
import personal.learning.jms.consumer.project.ProjectAllotment1;
import personal.learning.jms.consumer.project.ProjectAllotment2;
import personal.learning.jms.consumer.project.ProjectAllotment3;
...
public class AppConfig {
	...
	@Bean
	public ProjectAllotment1 projectAllotment1() {
		return new ProjectAllotment1();
	}
	
	@Bean
	public ProjectAllotment2 projectAllotment2() {
		return new ProjectAllotment2();
	}
	
	@Bean
	public ProjectAllotment3 projectAllotment3() {
		return new ProjectAllotment3();
	}
