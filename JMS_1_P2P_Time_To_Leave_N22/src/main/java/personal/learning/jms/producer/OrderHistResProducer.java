...
/*
 *
<address-setting match="orderHistoryReqQueueTest">
	<dead-letter-address>DLQ</dead-letter-address>
    <expiry-address>ExpiryQueue</expiry-address>
	<max-delivery-attempts>3</max-delivery-attempts>
	<redelivery-delay>15000</redelivery-delay> <!-- 60 seconds for consumer A -->
	<expiry-delay>30000</expiry-delay> <!-- Set default TTL to 60 seconds -->
</address-setting>
 *
 */
...
public class OrderHistResProducer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			producer.send(objectMessage1, DeliveryMode.NON_PERSISTENT, 4, 15000); // TTL = 15000 millisecs = 15 sec
			...
			producer.send(objectMessage2, DeliveryMode.NON_PERSISTENT, 2, 15000);
			...
			producer.send(objectMessage3, DeliveryMode.NON_PERSISTENT, 6, 60000);
			...
			producer.send(objectMessage3, DeliveryMode.PERSISTENT, 3, 10000);
			...
			producer.send(objectMessage6, DeliveryMode.NON_PERSISTENT, 3, 6000);
