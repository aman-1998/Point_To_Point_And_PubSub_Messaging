...
public class OrderHistReqConsumer3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MessageConsumer consumer = session.createConsumer(orderHistoryReqQueue, "JMSType = 'Madhu request'");
			...
			System.out.println("Consumer3  waiting for message...");
