...
public class OrderHistResProducer1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			objectMessage1.setStringProperty("gender", "Female");
			...
			objectMessage2.setStringProperty("gender", "Male");
			...
			objectMessage3.setStringProperty("gender", "Female");
			...
			objectMessage4.setStringProperty("gender", "Male");
			...
			objectMessage5.setStringProperty("gender", "Male");
			...
			objectMessage6.setStringProperty("gender", "Male");
