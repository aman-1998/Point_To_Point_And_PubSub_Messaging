...
public class OrderHistResProducer3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			objectMessage1.setJMSType("Star Neha request");
			...
			objectMessage2.setJMSType("Aman request");
			...
			objectMessage3.setJMSType("Madhu request");
			...
			objectMessage4.setJMSType("Ravi request");
			...
			objectMessage5.setJMSType("Mithila Nagri request");
			...
			objectMessage6.setJMSType("Kohli request");
