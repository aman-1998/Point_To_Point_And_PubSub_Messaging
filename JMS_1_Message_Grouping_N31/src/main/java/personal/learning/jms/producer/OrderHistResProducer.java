...
public class OrderHistResProducer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			connection = connectionFactory.createConnection("producerUser", "producerUser");
			session = connection.createSession(Session.CLIENT_ACKNOWLEDGE);
			
			Queue orderHistoryReqQueue = session.createQueue("ordHistReqQueue");
			Queue orderHistoryResQueue = session.createQueue("ordHistResQueue");
			...
			objectMessage1.setStringProperty("JMSXGroupID", "Group-0");
			...
			objectMessage2.setStringProperty("JMSXGroupID", "Group-1");
			...
			objectMessage3.setStringProperty("JMSXGroupID", "Group-0");
			...
			objectMessage4.setStringProperty("JMSXGroupID", "Group-1");
			...
			objectMessage5.setStringProperty("JMSXGroupID", "Group-1");
			...
			objectMessage6.setStringProperty("JMSXGroupID", "Group-1");
